...
1.  We revisited our model and fully restructured our manuscript based on the new results.
2.  We substantially expanded Results and Discussion based on reviewer's comments.
3.  Where appropriate, we re-worded text throughout the manuscript.
...
> We have revisited our model in light of comments from Reviewer 1. In the revised version, $\delta$ is the proportional contribution of $B$ to the predator. We have clarified this point in Methods. Also, we have avoided the term "structural constraint" as it causes confusion.
...
> In light of comments from Reviewer 1, we have reanalyzed and fully re-structured Results and Discussion according to the new results. Competition was an improper explanation; please see our response to your next comment for details.
...
> We appreciate your insight. In the revised MS, we used a combination of $r_b$ and carrying capacity $K$ to represent low and high productivity scenarios. Indeed. it has greatly changed the results. Please see the revised results in the main text.
...
> Agreed, it will certainly help improve the understanding of how branching affects FCL. However, we are afraid that the inclusion of this aspect is beyond the scope of this manuscript. The current manuscript contains rich test and figures already -- adding a new component would make the manuscript less accessible. We hope the reviewer will understand our decision.
...
> True. We have removed this statement in the revised MS. Although it might be possible to quantify the effect sizes and compare them, this result is not a significant portion of the manuscript. We appreciate your suggestion though!
...
> We believe it is linked to the saturation of dispersing propagules -- ecosystem size and complexity are likely to increase FCL by increasing immigrants from less disturbed patches. However, in large or complex ecosystems, dispersal propagules may not be a limiting factor of FCL as the supply is plenty; therefore, productivity or omnivory more strongly regulated FCL. We have clarified this point in Discussion (2nd paragraph).
...
> In the re-analysis, we did observe stronger effects of productivity (see *Productivity effect* in Results). We have fully restructured it and expended discussion according to this change. Our supplementary analysis of one-patch simulations highlighted the strong dependence of FCL on local productivity. We have clarified this point in the revised MS.
...
> We are glad the reviewer picked this! Although the darkness was supposed to represent the strength of trophic interactions, we removed this because it might cause confusion. This figure is just a conceptual visualization and does not quantitatively represent simulation setups.
...
> Thank you. We have reworded. Smaller/simpler ecosystems were more vulnerable to disturbance. We also added text about the saturation of immigration effects at high levels of size and complexity (see our response above).
...
> True. We have removed this part of text during the current revision. Discussion has been fully restructured.
...
> The comment ended in the middle, so we were not able to correctly understand what it was supposed to mean. However, we suspect the referenced sentence needs to be improved. We have fully restructured this part in the revised MS because ecosystem geometry effects were now dependent on omnivory.
