...
list.files(here::here("code")) %>% 
  as_tibble() %>% 
  mutate(Description = case_when(str_detect(value, "^figure_")~"Code for figures: '_concept', Figure 1; '_delta', Figure 1D; '_food_web', Figure 1C; '_treeplot', Figure2; '_main_geom', Figure 3, 4; '_network', Figure 1A; '_patch_state', Figure 5, 6",
