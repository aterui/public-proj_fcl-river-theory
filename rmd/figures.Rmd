...
**Figure 3** Ecosystem size (A) and complexity (B) influence food chain length under high disturbance regime. Lines are loess curves fitted to simulated data and are colored based on omnivory. Shaded ribbons are 95% confidence intervals. Parameters for high disturbance regime: disturbance probability $p_{m} = 0.01$ and mean proportional mortality at headwaters $\mu_{m}=0.8$.
