...
There were three consistent patterns in the relationship between FCL and ecosystem geometry (size and complexity). First, positive effects of ecosystem size and complexity were generally found when both disturbance frequency and intensity were high. Second, omnivory plays a central role in modulating the effects of ecosystem geometry on the FCL. Third, resource availability and dispersal did not change the qualitative relationship between the FCL and ecosystem geometry, although they had important direct effects on the FCL.

## Ecosystem geometry interacts with disturbance

Ecosystem geometry interacted with disturbance to dictate FCL in branching ecosystems. With no disturbance, both geometric features (size and complexity) had limited influence on FCL. However, as disturbance frequency increases, the relationships between FCL and ecosystem geometry became positive. The exception is the "chain" scenario (i.e., no omnivory). When this food web structure was combined with no disturbance, ecosystem size had a clear positive effect on FCL while ecosystem complexity had a negative influence. These opposing influences of ecosystem size and complexity may reflect their contrasting impacts on the total carrying capacity within a network (i.e., carrying capacity summed across all patches): ecosystem size increases the total carrying capacity whereas ecosystem complexity decreases it.
...
## Ecosystem geometry interacts with omnivory
