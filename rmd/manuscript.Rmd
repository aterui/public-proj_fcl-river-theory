...
where $s_{0,i}$ is the background survival probability (density independent), $\beta_{i,x}(t)$ the survival probability after predation, and $\gamma_{x}(t)$ the survival probability after stochastic disturbance. The function $g_i(\centerdot)$ defines the form of the density-dependent recruitment for species $i$.

For the basal species, we considered the predation impacts by consumer and predator species:
