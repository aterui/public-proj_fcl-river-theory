...
$$
\begin{aligned}
A_{i,x}(t+1) &\sim \text{Poisson}(\bar{A}_{i,x}(t) + I_{i,x}(t) - E_{i,x}(t)) &&\text{(4)}
\end{aligned}
$$
...
***Internal dynamics.*** Each time step starts with internal dynamics. We modeled density-dependent growth after accounting for background and predator-induced mortality:
