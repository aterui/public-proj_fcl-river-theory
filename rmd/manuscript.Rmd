...
There were two consistent patterns in the relationship between FCL and ecosystem geometry (size and complexity). First, the effects of ecosystem size and complexity were modulated by disturbance and omnivory. Second, resource availability and dispersal had limited influences on the qualitative relationship between FCL and ecosystem geometry, although they had important direct effects on the FCL. Below we describe these results in detail.

## Interactive effects of ecosystem geometry, disturbance, and omnivory
...
The exception is the "chain" scenario (i.e., no omnivory) with no disturbance. In this scenario, ecosystem size had a clear positive effect on FCL (**Figure 2**) while ecosystem complexity had a negative influence (**Figure 3**). These opposing influences of ecosystem size and complexity were associated with their contrasting relationships with the total carrying capacity (i.e., carrying capacity summed across all patches): ecosystem size increases the total carrying capacity whereas ecosystem complexity decreases it (**Figure XXX**). However, these patterns characteristic to the "chain" scenario diminished when considering some levels of omnivory because FCLs with omnivory were less reliant on the carrying capacity of the basal species.

## Productivity and dispersal

Productivity and dispersal had limited influences on the qualitative relationship between FCL and ecosystem geometry. However, they had important direct effects on FCL. Productivity influences were dependent on omnivory. Overall, greater productivity increased (chain & strong omnivory) or decreased FCL (weak omnivory), although the effect size varied with ecosystem geometry and disturbance levels. Dispersal distance had a positive effect on FCL, particularly in scenarios with frequent and intense disturbance.

## Underlying state changes

State transition shed lights on how FCL changes occurred. In the chain motif, the "additive" mechanism (i.e., the addition of higher trophic levels) is always responsible for the changes in FCL. With disturbance, state transition occurred from "B" to "B + C" as ecosystem size or complexity increases. With no disturbance, state transition was different between size and complexity. Ecosystem size facilitated the transition from "B + C" to "B + C + P", while ecosystem complexity drove the opposite transition ("B + C + P" $\rightarrow$ "B + C").

In the weak and strong omnivory motifs, ecosystem size and complexity increased FCL through different mechanisms. Ecosystem size increased FCL primarily through the additive mechanism, facilitating the state transition from "B" to "B + P", particularly with frequent disturbance. However, the "insertion" mechanism (the transition from "B + P" to "B + C + P") also took place in the strong omnivory motif with rare disturbance ($p_m = 0.05$). In contrast, the insertion mechanism was responsible for the effect of ecosystem complexity on FCL. In the weak omnivory scenario, the transition from "B + P" to "B + C + P" was predominant. In the strong omnivory scenario, transition patterns depended on disturbance frequency. When disturbance was rare ($p_m = 0.05$), the insertion mechanism ("B + P" $\rightarrow$ "B + C + P") drove the FCL change. However, as disturbance frequency increased, the primary process switched to the additive mechanism ("B" $\rightarrow$ "B + P").
...
The most important finding in this study is the synergistic effects between ecosystem geometry and disturbance. Our no disturbance scenario can be viewed as habitat networks having nearly homogeneous environments, in which long food chains were generally supported independently of ecosystem size and complexity (except the chain scenario). However, as the frequency of intense disturbance increases, small and/or simple networks could not maintain long food chains because habitats were too homogeneous with limited disturbance refugia. While empirical studies rarely looked at the influence of ecosystem complexity on FCL, several studies provide some support for this theoretical prediction. For example, @sullivanEcosystemStructureEmerges2015 reported FCL is controlled primarily by the number of tributary confluences in Idaho streams. Similarly, it has been shown that the merging of major tributaries lengthened FCL in the Colorado River, especially during a post-monsoon turbid water phase [@saboPulsedFlowsTributary2018]. More empirical research is needed to confirm our theoretical predictions.

The synergy between ecosystem geometry and disturbance has also an implication for why the dynamical stability hypothesis [@pimmNumberTrophicLevels1977] has been least supported by the literature. While increased disturbance frequency consistently reduced FCL, its magnitude depended strongly on ecosystem geometry. This observation should provide a possible explanation for the limited support for the dynamical stability hypothesis, because such an interaction has been rarely assessed in previous studies. Although FCL research often assumes that the effects of environmental controls are independent of one another, exploring potential interactions among them could provide useful insights into what controls FCL in nature.
...
Another interesting result of our simulation is the interaction with omnivory. In particular, when the chain motif was combined with no-disturbance, ecosystem size and complexity had contrasting influences on FCL. It is evident from the one-patch simulation that the chain motif is highly sensitive to local carrying capacity; therefore, the total carrying capacity within a network dictates FCL. This effect of ecosystem size is understandable because it simply increases the total carrying capacity. In contrast, ecosystem complexity, here assessed as branching probability, decreased the total carrying capacity as more branched networks have disproportionate numbers of headwater habitats with small local carrying capacities. Thus, ecosystem complexity had an opposite effect on FCL with the chain motif. However, the dependence of FCL on local carrying capacity diminished in weak and strong omnivory scenarios. This fact explains the lack of positive (ecosystem size) or negative FCL-geomtery relationship (ecosystem complexity) in these motifs with no disturbance.

Importantly, however, disturbance overwhelmed the effect of omnivory on the FCL-geometry relationships: as the frequency of intense disturbance increases, the positive relationships between FCL and ecosystem geometry emerged regardless of omnivory levels. This result provides a possible explanation for why the ecosystem size hypothesis has been consistently supported in various ecosystems [@takimotoEnvironmentalDeterminantsFoodchain2013] and raises the possibility of ecosystem complexity as an important control of FCL in branching networks. Our results also imply that, if disturbance is strong and frequent, the effects of ecosystem geometry are robust to food web reorganization, which is often associated with species extirpations or introductions. The strength of omnivory in these novel communities can be increased or decreased, depending on the introduced species and the extant species pool or community. For example, non-indigenous fishes in the Eastern Mediterranean Sea outcompete native species for high-quality prey items, causing native species to increase their consumption of non-preferred prey items [@fanelliDepictingNovelEastern2015]. However, such substantial food web reorganization may have limited influences on how ecosystem geometry dictates FCL.

The effect of productivity was context-dependent, supporting previous theoretical predictions [@postProximateStructuralMechanisms2007; @kondohFoodchainLengthAdaptive2009; @wardMechanisticTheoryAquatic2017]. While productivity clearly increased FCL in the chain motif, this effect was vague (strong omnivory) or even reversed (weak omnivory) in omnivory motifs. With omnivory, high productivity effectively increases the abundance of the basal species, stimulating the prey switching of the intraguild predator from the intraguild prey to the basal species. As such, increased productivity does not necessarily increase FCL. Our results suggest that this prediction from non-spatial models can be applied to spatially complex ecosystems.
