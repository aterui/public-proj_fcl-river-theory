...
Ecosystem geometry interacted with disturbance to dictate FCL in branching ecosystems. With no disturbance, both geometric features (size and complexity) had limited influence on FCL. However, as disturbance frequency increases, the relationships between FCL and ecosystem geometry became positive. This interactive effect emerged because the sensitivity of FCL to disturbance depended on ecosystem geometry. Although increased disturbance frequency reduced overall FCL, smaller and/or simpler ecosystems exhibited the greater vulnerability. Therefore, disturbance interact with ecosystem geometry, producing the interdependency of these factors in determining FCL. The interactive effects, however, were not observed with low disturbance intensity (proportion of individuals removed per disturbance event); this suggests that disturbance intensity must be strong enough to be influential.

The exception is the "chain" scenario (i.e., no omnivory) with no disturbance. In this scenario, ecosystem size had a clear positive effect on FCL while ecosystem complexity had a negative influence. These opposing influences of ecosystem size and complexity were associated with their contrasting relationships with the total carrying capacity (i.e., carrying capacity summed across all patches): ecosystem size increases the total carrying capacity whereas ecosystem complexity decreases it. However, these patterns characteristic to the "chain" scenario diminished when considering some levels of omnivory because food webs with omnivory were less reliant on the carrying capacity of the basal species.
...
Another interesting result of our simulation is the interaction with omnivory. In particular, when the chain motif was combined with no-disturbance, ecosystem size and complexity had contrasting influences on FCL. It is evident from the one-patch simulation that the chain motif is highly sensitive to local carrying capacity; therefore, the total carrying capacity within a network dictates FCL. The effect of ecosystem size is understandable because it simply increases the total carrying capacity. In contrast, ecosystem complexity, here assessed as branching probability, decreases the total carrying capacity as more branched networks have disproportionate numbers of headwater habitats with small local carrying capacities. However, the dependence of FCL on local carrying capacity diminished in weak and strong omnivory scenarios, explaining the lack of positive (ecosystem size) or negative FCL-geomtery relationship (ecosystem complexity) in these motifs with no disturbance.
...
The effect of productivity was context dependent, supporting previous theoretical predictions. While productivity clearly increased FCL in the chain motif, this effect was vague (strong omnivory) or even reversed (weak omnivory). High productivity effectively increases the abundance of the basal species, stimulating the prey switching of the intraguild predator from the intraguild prey to the basal species. As such, increased productivity does not necessarily increase FCL. Our results suggest that this prediction from non-spatial models can be applied to spatially complex ecosystems.

Ecosystem size and complexity led to the distinct patterns of state transitions. The state transitions with increased ecosystem size are likely associated with increased immigration. It is clear that the total number of dispersing propagules increases with increasing ecosystem size, providing opportunities to maintain longer food chains. The exception was the strong omnivory motif with rare disturbance, in which the insertion mechanism operated. This is likely because rare disturbance inhibited the exclusion of the intraguild prey by suppressing the abundance of the intraguild predator. Similarly, increased immigration may be generally responsible for the state transitions with increasing ecosystem complexity. Habitat patches are closer in more branched networks as it compresses the network configuration. However, unlike ecosystem size, ecosystem complexity does not increase the total number of dispersing propagules - rather, it enhances connectivity among habitat patches. This difference may explain the distinct patterns of state transitions along the gradients of ecosystem size and complexity.
