...
***Food chain length.*** At each patch and time step, we determined FCL  as the highest trophic position ($TP_{x}(t)$) of the existing species. When the intraguild predator exists, the trophic position is determined as follows:
