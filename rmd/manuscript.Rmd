...
The exception is the "chain" scenario (i.e., no omnivory) with no disturbance. In this scenario, ecosystem size had a clear positive effect on FCL while ecosystem complexity had a negative influence. These opposing influences of ecosystem size and complexity may reflect their contrasting impacts on the total carrying capacity within a network (i.e., carrying capacity summed across all patches): ecosystem size increases the total carrying capacity whereas ecosystem complexity decreases it. However, these patterns characteristic to the "chain" scenario diminished when considering some levels of omnivory because food webs with omnivory were less reliant on the carrying capacity of the basal species. In addition, omnivory gave rise to more robustness/resilience to increased disturbance frequency.
