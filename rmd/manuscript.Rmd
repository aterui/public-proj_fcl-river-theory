...
***Food chain length.*** At each patch and time step, FCL was determined as the highest trophic position ($TP_{x}(t)$) of the existing species. When the intraguild predator exists, the trophic position was determined as follows:
...
Our simulation highlighted the interactive nature of putative controls of FCL. In particular, disturbance regimes had the strongest influence on the qualitative relationships between FCL and ecosystem properties. Below, we report our results for low and high disturbance regimens separately.

## **Low disturbance regime**

In ecosystems with a low disturbance regime, FCL was largely determined by omnivory with limited effects of ecosystem size and complexity (colored lines in **Figure 2**). FCL was negatively related to the degree of omnivory, with no-omnivory food chains ($P$ only consumes $C$) having the longest FCL, and strong omnivory ($P$ consumes very little $C$) having the shortest FCL. The primary mechanism for the decreased FCL was different in low and high productivity scenarios. With low productivity, FCL became shorter with stronger omnivory because it intensifies competition between consumer and predator species. This effect can be seen in the decreased occupancies of consumer and predator species in a low productivity scenario (most left column in **Figure S1-S4**). However, when productivity was high, the occupancies of both species were \~1.0, indicating that the structural constraint of strong omnivory made FCL shorter (second left column in **Figure S1-S4**). Productivity played a secondary role in increasing FCL, particularly when omnivory was strong (compare left and right panels in **Figure 2**). Dispersal had no apparent effects on FCL (compare top and bottom panels in **Figure 2**). These trends were consistent across dispersal scenarios (**Figure 2**).

Although the effects of ecosystem properties on FCL were minimal, there were noticeable effects on the occupancies of constituent species in some scenarios. For example, the occupancies of $C$ and $P$ increased with ecosystem size when omnivory was strong (see the most left column in **Figures S1 and S2**). However, these changes were not translated into FCL because $C$ and $P$ occupy a similar trophic position (**Figure 1D**). Similarly, the occupancy of $P$ decreased with ecosystem complexity when omnivory was strong, but FCL remained almost the same as the increase of $C$ could compensate for the loss of $P$ for the same reason (**Figure S3 and S4**).

## **High disturbance regime**

On average, increased disturbance frequency decreased FCL, and omnivory had similar effects on FCL (**Figures 3**). More importantly, a high disturbance regime produced much different responses of FCL to ecosystem properties. FCL increased across both gradients of ecosystem size and complexity under all combinations of productivity, omnivory, and dispersal distance (**Figure 3**). The effect of ecosystem complexity was generally clearer than that of ecosystem size. It is important to note that the positive relationships emerged in a high disturbance regime because smaller and simpler ecosystems were disproportionately vulnerable to increased disturbance frequency (compare far left in **Figures 2 and 3**).
