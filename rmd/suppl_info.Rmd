...
Based on the results, we considered ecological scenarios relevant for putative controls of food chain: low and high productivity ($r_b = 4, 8$), low and high disturbance ($p_b = 0.01, 0.1$), and three food web architecture ("Chain" [$\{e_{bc}, e_{bp}, e_{cp}\} = \{4, 0, 4\}, \{a_{bc}, a_{bp}, a_{cp}\} = \{0.5, 0.1, 0.5\}$], "Weak omnivory" [$\{e_{bc}, e_{bp}, e_{cp}\} = \{4, 2, 4\}, \{a_{bc}, a_{bp}, a_{cp}\} = \{0.5, 0.1, 0.5\}$], and "Strong omnivory" [$\{e_{bc}, e_{bp}, e_{cp}\} = \{4, 4, 2\}, \{a_{bc}, a_{bp}, a_{cp}\} = \{0.5, 0.5, 0.1\}$]). Handling times were fixed at $0.5$ to reduce the number of parameter combinations.
